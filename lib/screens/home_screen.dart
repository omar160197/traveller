...
import 'package:untitled/widgets/destination_carousel.dart';
import 'package:untitled/widgets/hotel_carousel.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: ListView(
          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsets.only(left: 20.0, right: 75.0),
              child: Text(
